# -*- coding: utf-8 -*-
"""
Created on Sun May  9 10:23:53 2021
...
def Detector():  
    ...
    face_detect = cv2.CascadeClassifier('C:/Users/Sristi/anaconda3/Lib/site-packages/cv2/data/haarcascade_frontalface_default.xml')
    
    #Mask Detection Model
    mod = load_model('E:/ASHTrinity/FrostHack/firstproj/app1/model-best/')
    
    np.set_printoptions(suppress=True)
    
    # Type of Mask Detection Model
    model = tensorflow.keras.models.load_model('E:/ASHTrinity/FrostHack/firstproj/app1/keras_model.h5',compile=False)
